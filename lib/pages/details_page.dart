                            ...
                            onTap: () {
                              if (favouriteProvider
                                ...
                                ScaffoldMessenger.of(context)
                                  ...
                                  content:
                                      const Text("Đã được thêm vào yêu thích"),
                                  action: SnackBarAction(
                                    label: "Hoàn tác",
                                    textColor: AppColors.white,
                                    onPressed: () {
                                      favouriteProvider
                                          .removeFavoriteFromSnackBar(
                                              widget.cardData);
                                    },
                                  ),
                        ...
                        onTap: () {
                          if (cartProvider.isInCart(widget.cardData)) {
                            ...
                            ScaffoldMessenger.of(context)
                                .showSnackBar(const SnackBar(
                              content:
                                  Text("Mặt hàng đã được thêm vào giỏ hàng"),
                      ...
                      Text.rich(
                        TextSpan(
                          children: [
                            TextSpan(
                              text:
                                  '${widget.cardData.price.toString()}.000 đồng',
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          GestureDetector(
            onTap: () {
              pushNewScreen(context, screen: const Cart(), withNavBar: false);
            },
            child: Container(
              height: 65,
              width: 65,
